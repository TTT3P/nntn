// meat-stock/produce-pot.js — หม้อตุ๋น pot modals: cook helper, create-new-pot,
// close-pot (yield calc, dup-warning, submit). Split from produce.js (step 7).
// Classic <script src>, globals shared (state lives in produce-kanban.js, loaded first).
