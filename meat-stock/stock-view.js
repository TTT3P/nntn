// meat-stock/stock-view.js — สต๊อกปัจจุบัน tab: yield analytics, live stock board,
// warehouse expand, bag trace modal. Split from stock.js (step 9). Classic <script src>.
