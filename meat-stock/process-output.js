...
const REPACK_MAP = {
  ...
  'MT-046': ['MT-040','MT-051'],           // ชายโครงตุ๋น (เนื้อตุ๋น) → [75G]เนื้อตุ๋น + [75G]เนื้อตุ๋น(ราดข้าว) (02/09 TINE: เพิ่ม MT-051 ราดข้าว mirror MT-028; 26/08 MT-054 merged→MT-040)
  ...
  'SP-036': ['MT-007','MT-053','MT-052','MT-055','MT-060'],   // สันนอก (ดิบ) → [75G]/[100G]/[150G]/[500G]แดดเดียว + [100G]แดดเดียว(พิเศษ) MT-055 (MT-053 19/07 · MT-055 26/07 TINE route A: เนื้อ/ต้นทุนเท่า MT-053 · MT-060 [500G] 12/09 TINE)
  ...
  'MT-048': ['MT-011','MT-050'],           // เศษเนื้อน่องกรอบ (ดิบ) → [75G]เนื้อบด (14/07 นโยบายเศษดิบ) + MT-050 เศษเนื้อน่องกรอบตุ๋น (05/09 TINE: เพิ่มเส้นตุ๋น — เอาเศษดิบไปตุ๋นได้ ใช้ MT-050 เดิม)
