window.NNTNKitchenSotFirstSetV2 = {
  ...
  "recipes": [
    ...
    },
    {
      ...
      "items": [
        {
          "line_key": "เครื่องปรุงชุดสอง:สูตรทั้งชุด",
          "item_name": "สูตรทั้งชุด",
          "item_kind": "direct_ingredient",
          "component_recipe_id": null,
          "source_values": {
            "v1": "ซอสลับ 250 ml + น้ำตาลกรวด 120 g + โชยุ 20 g + รสดีเนื้อ 50 g + เกลือ 3 g + ม้ามตุ๋น 200 g",
    ...
    },
    {
      ...
      "blockers": [
        {
          "code": "unresolved_source_conflict",
          "message": "น้ำจิ้มซีฟู้ด 20 กรัมเสิร์ฟตรงไหน และผัดผักนับเป็น 1 ชุดหรือ 53 กรัม"
        }
      ]
    },
    {
