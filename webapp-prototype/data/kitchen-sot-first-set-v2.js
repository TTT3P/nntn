      ...
      "work_documents": {
        "service": {
          ...
          "ingredient_line_keys": [
            "ข้าวหน้าเนื้อตุ๋น:เนื้อตุ๋น (ราดข้าว)",
            "ข้าวหน้าเนื้อตุ๋น:ข้าวญี่ปุ่น",
            "ข้าวหน้าเนื้อตุ๋น:น้ำจิ้มซีฟู้ด",
            "ข้าวหน้าเนื้อตุ๋น:ผักชีไทย"
          ],
          "steps": [
            "นำเนื้อตุ๋นที่แพ็คไว้ไปอุ่นในไมโครเวฟ ไฟแรง 2 นาที",
            "นำน้ำเนื้อตุ๋นเทใส่ถ้วยน้ำจิ้ม ส่วนตัวเนื้อเทใส่ถาดรองอาหาร โรยด้วยผักชีไทยนิดหน่อย เสิร์ฟคู่กับน้ำจิ้มซีฟู๊ด"
          ]
        }
      }
    },
    {
      ...
      "work_documents": {
        "prep": {
          ...
          "scalable": true,
          "ingredient_line_keys": [
            "เนื้อตุ๋น (ราดข้าว):เนื้อตุ๋น",
            "เนื้อตุ๋น (ราดข้าว):น้ำซุปในหม้อหุงข้าว",
            "เนื้อตุ๋น (ราดข้าว):น้ำเปล่า",
            "เนื้อตุ๋น (ราดข้าว):แม็กกี้ Seasoning",
            "เนื้อตุ๋น (ราดข้าว):เหล้าจีน",
            "เนื้อตุ๋น (ราดข้าว):ซีอิ๊วขาว Amoy",
            "เนื้อตุ๋น (ราดข้าว):น้ำตาลทรายไม่ขัดสี",
            "เนื้อตุ๋น (ราดข้าว):ผงชูรส",
            "เนื้อตุ๋น (ราดข้าว):แป้งมันฮ่องกง",
            "เนื้อตุ๋น (ราดข้าว):แป้งข้าวโพด",
            "เนื้อตุ๋น (ราดข้าว):น้ำสำหรับผสมแป้ง"
          ],
          "steps": [
            "นำเนื้อสามชั้นตุ๋นมาหั่น ชิ้นละ 10 กรัม จากนั้นนำน้ำซุปจากหม้อหุงข้าว และน้ำเปล่า อย่างละ 1000 ml เทใส่ในหม้อที่เตรียมไว้",
            "นำเนื้อสามชั้นลงไปในหม้อ และตั้งไฟตุ๋นต่อ 45 นาที",
            "พอครบ 45 นาที นำซีอิ๊วขาว น้ำตาลทรายไม่ขัดสี ผงชูรส ใส่ลงไปในหม้อคนให้เข้ากัน จากนั้นเปิดไฟแรงให้น้ำเดือด และใส่เหล้าจีนลงไป",
            "คนเครื่องปรุงทุกอย่างให้เข้ากัน นำแป้งทั้ง 2 อย่าง (แป้งมันฮ่องกง + แป้งข้าวโพด) มาผสมกับน้ำเปล่า 120 ml และค่อยๆ หยอดเติมลงไปในหม้อตุ๋น ระหว่างที่เติมแป้งลงไปต้องคนตลอดเวลา",
            "หลังจากใส่แป้งและคนจนเข้ากันแล้ว จะสังเกตเห็นว่าเนื้อในหม้อเริ่มข้นและหนืดขึ้น ลดไฟให้เหลือปานกลางค่อนอ่อน และตุ๋นทิ้งไว้อีก 5 นาที และแพ็คใส่ถุงสำหรับเตรียมขาย"
          ]
        }
      }
    },
    {
      ...
      "work_documents": {
        "prep": {
          ...
          "scalable": true,
          "ingredient_line_keys": [
            "น้ำซุปก๋วยเตี๋ยว V3:น้ำเปล่า",
            "น้ำซุปก๋วยเตี๋ยว V3:ซอสลับสำหรับซุป V3",
            "น้ำซุปก๋วยเตี๋ยว V3:น้ำตาลมะพร้าว",
            "น้ำซุปก๋วยเตี๋ยว V3:น้ำตาลกรวด",
            "น้ำซุปก๋วยเตี๋ยว V3:รสดีก๋วยเตี๋ยวเข้มข้น",
            "น้ำซุปก๋วยเตี๋ยว V3:รสดี ผงปรุงรสเนื้อ",
            "น้ำซุปก๋วยเตี๋ยว V3:ซีอิ๊วดำ",
            "น้ำซุปก๋วยเตี๋ยว V3:กระเทียมดอง",
            "น้ำซุปก๋วยเตี๋ยว V3:เกลือ",
            "น้ำซุปก๋วยเตี๋ยว V3:มะกรูด",
            "น้ำซุปก๋วยเตี๋ยว V3:ใบเตย",
            "น้ำซุปก๋วยเตี๋ยว V3:หัวไชเท้า",
            "น้ำซุปก๋วยเตี๋ยว V3:ชุดเครื่องเทศสำหรับซุป V3",
            "น้ำซุปก๋วยเตี๋ยว V3:ชุดปรุงรอบ 2 สำหรับซุป V3"
          ],
          "steps": []
        }
      }
    },
    {
      ...
      "work_documents": {
        "prep": {
          ...
          "scalable": true,
          "ingredient_line_keys": [
            "ซอสลับสำหรับซุป V3:โชยุ",
            "ซอสลับสำหรับซุป V3:ซอสฝาเขียว",
            "ซอสลับสำหรับซุป V3:ซีอิ๊วขาว",
            "ซอสลับสำหรับซุป V3:ซอสหอยนางรม"
          ],
          "steps": []
        }
      }
    },
    {
      ...
      "work_documents": {
        "prep": {
          ...
          "scalable": true,
          "ingredient_line_keys": [
            "ชุดเครื่องเทศสำหรับซุป V3:อบเชย",
            "ชุดเครื่องเทศสำหรับซุป V3:โป๊ยกั๊ก",
            "ชุดเครื่องเทศสำหรับซุป V3:พริกไทยดำ",
            "ชุดเครื่องเทศสำหรับซุป V3:กระเทียมจีน",
            "ชุดเครื่องเทศสำหรับซุป V3:รากผักชี",
            "ชุดเครื่องเทศสำหรับซุป V3:ข่าเหลือง",
            "ชุดเครื่องเทศสำหรับซุป V3:ซวงเจีย",
            "ชุดเครื่องเทศสำหรับซุป V3:ลูกเฉาก๋วย",
            "ชุดเครื่องเทศสำหรับซุป V3:ฮ่วยซัว",
            "ชุดเครื่องเทศสำหรับซุป V3:เก๋ากี้",
            "ชุดเครื่องเทศสำหรับซุป V3:หญ้าหอม"
          ],
          "steps": []
        }
      }
    },
    {
      ...
      "work_documents": {
        "prep": {
          ...
          "scalable": true,
          "ingredient_line_keys": [
            "ชุดปรุงรอบ 2 สำหรับซุป V3:ซอสถั่วเหลืองคิคโคแมน",
            "ชุดปรุงรอบ 2 สำหรับซุป V3:ซอสลับสำหรับซุป V3",
            "ชุดปรุงรอบ 2 สำหรับซุป V3:น้ำตาลกรวด",
            "ชุดปรุงรอบ 2 สำหรับซุป V3:รสดี ผงปรุงรสเนื้อ",
            "ชุดปรุงรอบ 2 สำหรับซุป V3:เกลือ",
            "ชุดปรุงรอบ 2 สำหรับซุป V3:ม้ามตุ๋น",
            "ชุดปรุงรอบ 2 สำหรับซุป V3:ใบเตย",
            "ชุดปรุงรอบ 2 สำหรับซุป V3:ข่า"
          ],
          "steps": []
        }
      }
    },
    {
      ...
      "work_documents": {
        "prep": {
          ...
          "scalable": true,
          "ingredient_line_keys": [
            "น้ำจิ้มซีฟู๊ด:น้ำมะนาว ARO",
            "น้ำจิ้มซีฟู๊ด:น้ำตาลทรายไม่ขัดสี",
            "น้ำจิ้มซีฟู๊ด:น้ำปลาทิพรส",
            "น้ำจิ้มซีฟู๊ด:ผงชูรส",
            "น้ำจิ้มซีฟู๊ด:พริกแดงจินดา",
            "น้ำจิ้มซีฟู๊ด:พริกเขียวจินดา",
            "น้ำจิ้มซีฟู๊ด:กระเทียมจีน",
            "น้ำจิ้มซีฟู๊ด:น้ำเปล่า"
          ],
          "steps": [
            "นำพริกและกระเทียมไปปั่นรวมกันให้ละเอียด",
            "หลังจากนั้น เตรียมเครื่องปรุงส่วนผสมทุกอย่างมาผสมรวมกัน และคนให้น้ำตาลทรายไม่ขัดสีละลาย ยกเว้นน้ำเปล่า",
            "พอส่วนผสมทุกอย่างเข้ากัน นำน้ำพริกและกระเทียมที่ปั่นไว้มาเทผสมรวมกัน จากนั้นเติมน้ำต้มสุก 100 กรัม"
          ]
        }
      }
    },
    {
      ...
      "work_documents": {
        "service": {
          ...
          "scalable": false,
          "ingredient_line_keys": [
            "ข้าวหน้าเนื้อยากินิกุ:ซอสยากินิกุ",
            "ข้าวหน้าเนื้อยากินิกุ:ผัดผัก",
            "ข้าวหน้าเนื้อยากินิกุ:น้ำจิ้มซีฟู้ด",
            "ข้าวหน้าเนื้อยากินิกุ:เนื้อพิคานย่า",
            "ข้าวหน้าเนื้อยากินิกุ:ข้าวญี่ปุ่น"
          ],
          "steps": [
            "เตรียมข้าวเปล่าจัดใส่กล่อง จากนั้นนำผัดผักที่เตรียมไว้จัดใส่บนข้าวข้างกล่อง",
            "นำเนื้อพิคานย่าที่ย่างไว้หั่นและเรียงบนข้าวข้างผัดผัก",
            "ราดซอสยากินิกุ 3 ช้อนโต๊ะลงบนเนื้อพิคานย่าและผัดผักให้ทั่ว"
          ]
        }
      }
    },
      ...
      "work_documents": {
        "prep": {
          ...
          "ingredient_line_keys": [
            "ซอสยากินิกุ:โชยุ",
            "ซอสยากินิกุ:มิริน",
            "ซอสยากินิกุ:น้ำตาลทรายไม่ขัดสี",
            "ซอสยากินิกุ:กระเทียมขูด",
            "ซอสยากินิกุ:ขิงขูด",
            "ซอสยากินิกุ:น้ำส้มสายชู",
            "ซอสยากินิกุ:น้ำมันงา",
            "ซอสยากินิกุ:งาคั่ว",
            "ซอสยากินิกุ:ชิโรดาชิ",
            "ซอสยากินิกุ:ฮอนสึยุ",
            "ซอสยากินิกุ:น้ำเปล่า"
          ],
          "steps": [
            "ตั้งหม้อเปิดไฟกลาง ใส่ซอสต่างๆ ลงไป ยกเว้นน้ำมันงา",
            "พอเริ่มเดือด ใส่งาคั่ว กระเทียมขูด ขิงขูด ตั้งไฟกลางต่อ 3 นาที",
            "หลังจากนั้นใส่น้ำมันงาลงไป ปรับไฟลงไฟเบาที่สุด หลังจากนั้นปิดไฟ เสร็จ"
          ]
        }
      }
    },
    {
      ...
      "work_documents": {
        "prep": {
          ...
          "ingredient_line_keys": [
            "ผัดผัก:กะหล่ำปลี",
            "ผัดผัก:แครอทหั่นเส้น",
            "ผัดผัก:น้ำมันปาล์ม",
            "ผัดผัก:ซอสอเนกประสงค์",
            "ผัดผัก:โชยุ",
            "ผัดผัก:น้ำมันงา",
            "ผัดผัก:งาขาวคั่ว"
          ],
          "steps": [
            "นำแครอทและกะหล่ำปลี อย่างละ 25 กรัม ใส่ในถ้วยและเติมน้ำเปล่าให้พอท่วมผัก จากนั้นนำเข้าไมโครเวฟไฟสูง 2 นาที",
            "เทน้ำออก สะเด็ดน้ำ ตั้งกระทะ เปิดไฟกลาง ใส่น้ำมัน 1 ช้อนชา ใส่ผักลงไปผัด ตามด้วยซอสอเนกประสงค์ 1 ช้อนชา โชยุ 1 กรัม น้ำมันงา 1 กรัม และงาขาวคั่ว 1 กรัม"
          ]
        }
      }
    },
    {
      ...
      "work_documents": {
        "prep": {
          ...
          "scalable": true,
          "ingredient_line_keys": [
            "ซอสอเนกประสงค์:น้ำมันหอย",
            "ซอสอเนกประสงค์:น้ำตาลทราย",
            "ซอสอเนกประสงค์:ซอสปรุงรสฝาเขียว",
            "ซอสอเนกประสงค์:คนอร์ไก่ฮ่องกง",
            "ซอสอเนกประสงค์:พริกไทยขาวป่น",
            "ซอสอเนกประสงค์:เหล้าจีน",
            "ซอสอเนกประสงค์:ผงชูรส"
          ],
          "steps": [
            "ใส่ส่วนผสมทั้งหมดลงในหม้อหรือภาชนะสำหรับทำซอส",
            "คนให้เข้ากันจนส่วนผสมละลายเข้ากันดี",
            "เปิดไฟอ่อนๆ เคี่ยวจนซอสเริ่มเดือด เพื่อให้เครื่องปรุงเข้ากันดี",
            "เมื่อซอสเดือดทั่ว ให้ปิดไฟและพักให้เย็น",
            "ตักใส่กล่องหรือขวดที่สะอาดและปิดฝาให้สนิท",
            "จัดเก็บ: ภาชนะปิดสนิทป้องกันอากาศและความชื้น · แช่เย็น 0–5°C เพื่อยืดอายุ · ใช้ได้ประมาณ 1 เดือนหลังผลิต",
            "การนำไปใช้: ซอสผัด ซอสหมัก หรือซอสปรุงรสทั่วไป · ใช้ในเมนูผัดกระเทียม ผัดเนื้อ ผัดน้ำมันหอย หรือซอสคลุกข้าวได้"
          ]
        }
    ...
    },
    {
      ...
      "work_documents": {
        "cook": {
          ...
          "scalable": false,
          "ingredient_line_keys": [
            "ข้าวขยำเนื้อแดดเดียว:เนื้อแดดเดียว"
          ],
          "steps": [
        ...
        "service": {
          ...
          "ingredient_line_keys": [
            "ข้าวขยำเนื้อแดดเดียว:เนื้อแดดเดียว",
            "ข้าวขยำเนื้อแดดเดียว:ข้าวหอมมะลิ",
            "ข้าวขยำเนื้อแดดเดียว:หอมอินเดีย",
            "ข้าวขยำเนื้อแดดเดียว:พริกแดงจินดา",
            "ข้าวขยำเนื้อแดดเดียว:ผักชีไทย",
            "ข้าวขยำเนื้อแดดเดียว:กระเทียมกรอบ",
            "ข้าวขยำเนื้อแดดเดียว:น้ำมะนาวสด",
            "ข้าวขยำเนื้อแดดเดียว:ผงชูรส",
            "ข้าวขยำเนื้อแดดเดียว:น้ำยำ"
          ],
          "steps": [
            "ตักข้าวใส่กล่อง นำผักต่างๆ จัดวางไว้รอบๆ กล่อง แล้วโปะเนื้อที่เตรียมไว้ลงไป ยกเว้นกระเทียมกรอบ",
            "จากนั้นตักน้ำยำ 1 ช้อนโต๊ะ ใส่ถ้วยสแตนเลสอันเล็ก ใส่น้ำมะนาว 1 ช้อนชา ผงชูรสปลายช้อน",
            "คนให้ละลายและเข้ากัน จากนั้นส่งให้คนหน้าบ้านเทใส่ถ้วยน้ำจิ้มพร้อมเสิร์ฟ",
            "นำกระเทียมกรอบใส่ถุงซิปแยกให้ลูกค้า",
            "(หมายเหตุ: น้ำยำ base ต่อ batch = น้ำตาลทราย 100g · น้ำปลา 100g · น้ำเปล่า 250g · น้ำตาลมะพร้าว 55g)"
          ]
        }
      }
    },
    {
      ...
      "work_documents": {
        "prep": {
          ...
          "scalable": true,
          "ingredient_line_keys": [
            "เนื้อแดด (ข้าวขยำ):สันนอก (ดิบ)",
            "เนื้อแดด (ข้าวขยำ):รสดีก๋วยเตี๋ยวเข้มข้น",
            "เนื้อแดด (ข้าวขยำ):น้ำตาลทรายไม่ขัดสี",
            "เนื้อแดด (ข้าวขยำ):ผงชูรส (อายิโนะโมะโต๊ะ)",
            "เนื้อแดด (ข้าวขยำ):ซอสหอยนางรม (ไฮนซ์)",
            "เนื้อแดด (ข้าวขยำ):เกลือสมุทร",
            "เนื้อแดด (ข้าวขยำ):พริกไทยดำเม็ด (ง่วนสูน)"
          ],
          "steps": [
            "หมักเนื้อตามสูตร 1 ชั่วโมง",
            "หากแดดแรง ตาก 1 ชั่วโมง จากนั้นกลับด้านและตากต่ออีก 30 นาที",
            "หากแดดไม่แรง ตากต่อเนื่อง 3 ชั่วโมงโดยไม่ต้องกลับด้าน"
          ]
        }
      }
    },
    {
      ...
      "work_documents": {
        "prep": {
          ...
          "scalable": true,
          "ingredient_line_keys": [
            "น้ำยำ:น้ำตาลทรายไม่ขัดสี",
            "น้ำยำ:น้ำปลาทิพรส",
            "น้ำยำ:น้ำตาลมะพร้าว",
            "น้ำยำ:น้ำเปล่า"
          ],
          "steps": [
            "ใส่น้ำปลาลงหม้อ ตั้งไฟกลาง รอให้เริ่มเดือดปุด ๆ มีกลิ่นหอม",
            "เบาไฟ ใส่น้ำตาล และน้ำเปล่า คนให้น้ำตาลละลาย",
            "เร่งไฟกลาง ให้เดือด · เบาไฟ เคี่ยวต่ออีก 5 นาที",
            "หมายเหตุ: ครัวเขียนมาเอง (ลายมือหน้า 21 · 2026-08-02) · หัวเรื่องครัวกำกับว่า \"(ข้าวขยำเนื้อ)\""
          ]
        }
      }
    },
    {
      ...
      "work_documents": {
        "cook": {
          ...
          "scalable": false,
          "ingredient_line_keys": [
            "เนื้อตุ๋นคั่วพริกเกลือ:พริกแดงจินดา",
            "เนื้อตุ๋นคั่วพริกเกลือ:ต้นหอมซอย",
            "เนื้อตุ๋นคั่วพริกเกลือ:พริกไทยป่น",
            "เนื้อตุ๋นคั่วพริกเกลือ:กระเทียมป่น",
            "เนื้อตุ๋นคั่วพริกเกลือ:เนื้อตุ๋น",
            "เนื้อตุ๋นคั่วพริกเกลือ:ผงคั่วพริกเกลือ"
          ],
          "steps": [
            "ตั้งกระทะเปิดไฟกลาง รวนเนื้อตุ๋นให้เปลี่ยนสี",
            "หลังจากเนื้อตุ๋นได้ที่ ใส่กระเทียมลงไปผัด ให้กระเทียมสุก ตามด้วยผงคั่วพริกเกลือ",
            "ผัดทุกอย่างให้เข้ากัน หลังจากนั้นใส่ต้นหอมซอยลงไป",
            "(ผงคั่วพริกเกลือ ผสมเป็น batch: น้ำตาลทรายไม่ขัดสี 90g · รสดีเนื้อ 120g · ผงชูรส 90g · เกลือ 30g — ต่อ 1 เสิร์ฟใช้ผง 1 ช้อนโต๊ะ + พริกจินดาแดง 3g + ต้นหอมซอย 3g + พริกไทยป่น 1g + กระเทียมสับ 5g)"
          ]
        }
      }
    },
    {
      ...
      "work_documents": {
        "prep": {
          ...
          "scalable": true,
          "ingredient_line_keys": [
            "ผงคั่วพริกเกลือ:น้ำตาลทรายไม่ขัดสี",
            "ผงคั่วพริกเกลือ:รสดีเนื้อ",
            "ผงคั่วพริกเกลือ:ผงชูรส",
            "ผงคั่วพริกเกลือ:เกลือ"
          ],
          "steps": []
        }
      }
    },
    {
      ...
      "work_documents": {
        "prep": {
          ...
          "scalable": true,
          "ingredient_line_keys": [
            "ข้าวญี่ปุ่นหุงสุก:ข้าวสารญี่ปุ่นดิบ",
            "ข้าวญี่ปุ่นหุงสุก:น้ำ",
            "ข้าวญี่ปุ่นหุงสุก:น้ำมันรำข้าว"
          ],
          "steps": [
            "ซาวข้าวโดยเติมน้ำให้ท่วมข้าว แล้วเทน้ำซาวออก ทำซ้ำรวม 2 รอบ",
            "เติมน้ำตามปริมาณที่ระบุในสูตร ใส่น้ำมันรำข้าว 1 ช้อนโต๊ะ แล้วนำไปหุง"
          ]
        }
      }
    },
    {
      ...
      "work_documents": {
        "prep": {
          ...
          "scalable": true,
          "ingredient_line_keys": [
            "ข้าวหอมมะลิหุงสุก:ข้าวหอมมะลิดิบ",
            "ข้าวหอมมะลิหุงสุก:น้ำ"
          ],
          "steps": [
            "ซาวข้าวโดยเติมน้ำให้ท่วมข้าว แล้วเทน้ำซาวออก ทำซ้ำรวม 2 รอบ",
            "เติมน้ำตามปริมาณที่ระบุในสูตร แล้วนำไปหุง"
          ]
        }
      }
    }
