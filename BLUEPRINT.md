...
## §16 Manual reconcile · Saga pattern

When you need to fix data divergence by hand (e.g., sm vs CW mismatch), follow this
compensating-write pattern. Adapted from VoltAgent workflow-orchestrator (saga +
compensation logic) · proven on MT-020/037/039/040 reconcile (25/04).
